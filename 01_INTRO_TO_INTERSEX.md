...
---
   ...
   Before you read this introduction to DSDs/Intersex, there is a refresher for those who feel they may be shaky on reproductive biology knowledge. [Here](/00_reproductive_bio_review.md) is a quick review of how sex is defined and differentiated. 
  
So now that we know how typical biological sex works, and how sex is determined in most cases, we can visit and define a difference of sex development, which is more colloquially known as an intersex condition. Difference of sex development (DSD) is the medical term for an individual who has a congenital and significant difference in their primary and secondary sex characteristics. This means that the individual has a significant difference in at least one of the five sex determinant characteristics that makes their set different from the typical: chromosomes, gonads, internal reproductive organs, genitalia and endocrine composition. This is a truly broad category, encompassing over 40 known conditions and with others that have yet to be classified or discovered. Around 0.5-1.7% of the population has an intersex condition/DSD, meaning that every large lecture hall at university will statistically contain at least one intersex person. For a relatively unknown phenomenon, it is quite common.
...
All of the currently known DSDs are located in another page, and if you are interested, you may look [here](/00_list_of_variations.md) for the comprehensive list. 
